...
l1tLayer1HGCal = cms.EDProducer("L1TCorrelatorLayer1Producer",
    ...
    hgcalInputConversionParameters = cms.PSet(
        ...
        multiclass_id = cms.PSet(
            ...
            wp_PU = cms.vdouble(0.33474750, 0.34946656),
            wp_Pi = cms.vdouble(0.25935340, 0.09397013),
            wp_EgEm = cms.vdouble(0.26641608, 0.34913054),
            wp_PFEm = cms.vdouble(0.26641608, 0.34913054),
        ),
