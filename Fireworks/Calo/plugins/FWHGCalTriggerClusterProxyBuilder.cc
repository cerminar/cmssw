...
private:
    ...
    const FWHGCalTriggerClusterProxyBuilder &operator=(const FWHGCalTriggerClusterProxyBuilder &) = delete; // stop default
...
REGISTER_FWPROXYBUILDER(FWHGCalTriggerClusterProxyBuilder, l1t::HGCalMulticluster, "HGCal Trigger Cluster", FWViewType::kAll3DBits);
